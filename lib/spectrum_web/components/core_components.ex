defmodule SpectrumWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpectrumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpectrumWeb.Gettext, "errors", msg, opts)
    end
  end
